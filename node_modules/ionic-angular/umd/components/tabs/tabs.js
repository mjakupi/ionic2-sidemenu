...
(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", '@angular/core', '../app/app', '../../config/config', '../../navigation/deep-linker', '../ion', '../../util/util', '../../navigation/nav-controller', '../../navigation/nav-util', '../../navigation/root-node', '../../platform/platform', './tab-highlight', '../../navigation/view-controller'], factory);
    }
    ...
    var Tabs = (function (_super) {
        ...
        Tabs.prototype._setIsPanel = function (isPanel) {
            // Conforms to RootNode abstract class
        };
        Tabs.prototype._isSideContent = function () {
        ...
        Tabs.decorators = [
            { type: core_1.Component, args: [{
                        ...
                        providers: [{ provide: root_node_1.RootNode, useExisting: core_1.forwardRef(function () { return Tabs; }) }]
                    },] },
        ];
        /** @nocollapse */
        Tabs.ctorParameters = [
