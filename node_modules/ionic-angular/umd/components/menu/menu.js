(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", '@angular/core', '../app/app', '../backdrop/backdrop', '../../config/config', '../content/content', '../../platform/dom-controller', '../../gestures/gesture-controller', '../../util/util', '../../platform/keyboard', './menu-gestures', './menu-controller', '../../platform/platform', '../../gestures/ui-event-manager', '../../navigation/root-node'], factory);
    }
    ...
    var Menu = (function () {
        ...
        Menu.prototype._isSideContent = function () {
            return true;
        };
        /**
         * @private
         ...
         * @private
         */
        Menu.prototype._setIsPanel = function (isPanel) {
        ...
        Menu.decorators = [
            { type: core_1.Component, args: [{
                        ...
                        providers: [{ provide: root_node_1.RootNode, useExisting: core_1.forwardRef(function () { return Menu; }) }]
                    },] },
        ];
        /** @nocollapse */
        Menu.ctorParameters = [
