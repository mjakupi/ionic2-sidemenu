...
(function (factory) {
    ...
    var Nav = (function (_super) {
         ...
         * @private
         */
        Nav.prototype._setIsPanel = function (isPanel) {
            if (isPanel) {
                this.resize();
            }
        };
         ...
         * @private
         */
        Nav.prototype._isSideContent = function () {
        ...
        Nav.decorators = [
            { type: core_1.Component, args: [{
                        ...
                        providers: [{ provide: root_node_1.RootNode, useExisting: core_1.forwardRef(function () { return Nav; }) }]
                    },] },
        ];
        /** @nocollapse */
        Nav.ctorParameters = [
